  ...
  {bikes
    ...
    .map((bike) => (
      ...
      <TouchableOpacity style={styles.iconButton} onPress={() => navigation.navigate('RentHistory')} >
        <Image source={require('../assets/images/HistoryIcon.png')}  style={[styles.iconImage, { tintColor: 'gray' }]}  // Gray out the History icon
         />
        <Text style={styles.iconText}>History</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.iconButton} onPress={() =>  navigation.navigate('RentNotify')} >
        <Image source={require('../assets/images/NotificationsIcon.png')}  style={[styles.iconImage, { tintColor: 'gray' }]}  // Gray out the Notifications icon
      ...
      >
        <Image source={require('../assets/images/AccountIcon.png')} style={[styles.iconImage, { tintColor: 'gray' }]}  // Gray out the Account icon
